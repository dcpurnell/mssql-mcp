...
export class ReadDataTool {
    constructor() {
        this.name = "read_data";
        this.description = "Executes a SELECT query on an MSSQL Database table. The query must start with SELECT and cannot contain any destructive SQL operations for security reasons.";
        this.inputSchema = {
            type: "object",
            properties: {
                query: {
